	...
	<div class = "col-md-9">
		<div class="container">
			<div class="row">
				...
				<hr style="border: 1px solid #2c313c;">
				<div class="col-md-3">
					<textarea name="my-text-area-3" id="my-text-area-3" cols="125" rows="7.5">Notify</textarea>
				</div>
				<hr style="border: 1px solid #2c313c;">
				<div class="col-md-3">
					<textarea name="my-text-area-4" id="my-text-area-4" cols="125" rows="7.5">Notify</textarea>
				</div>
			</div>
		</div>
	</div>
