...
@WebServlet("/MDTTranferXCTController")
public class MDTTranferXCTController extends HttpServlet {
	private static final long serialVersionUID = 1L;
    private DeTaiDAO dtDAO;   
    private DangKyDAO dkDAO;
    
    public MDTTranferXCTController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (IDDangNhap != null) {
            ...
            try {
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("/XemChiTetController");
